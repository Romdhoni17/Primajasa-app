...
<head>
  ...
  <script src="https://kit.fontawesome.com/0d8e9143b4.js" crossorigin="anonymous"></script>
...
<body>
  ...
  <header id="header" class="fixed-top ">
    <div class="container d-flex align-items-center justify-content-lg-between">
      ...
      <h1 class="logo me-auto me-lg-0"><a href="index.html">PRIMAJASA<span>.</span></a></h1>
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          ...
          <li class="dropdown"><a href="#"><span>Layanan</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
              <li class="dropdown"><a href="#"><span>Bus Reguler</span> <i class="bi bi-chevron-right"></i></a>
                <ul>
                  <li><a href="#">Super Executive</a></li>
                  <li><a href="#">AC Bisnis</a></li>
                  <li><a href="#">AC Ekonomi</a></li>
                </ul>
              </li>
              <li><a href="#">Angkutan Pemadu Moda</a></li>
              <li><a href="#">Redwhite Star Shuttle</a></li>
              <li class="dropdown"><a href="#"><span>Taxi</span> <i class="bi bi-chevron-right"></i></a>
                <ul>
    ...
    <div class="container" data-aos="fade-up">
      ...
      <div class="row justify-content-center" data-aos="fade-up" data-aos-delay="150">
        <div class="col-xl-6 col-lg-8">
          <h1>Layanan Transportasi Bis Primajasa<span>.</span></h1>
          <h2>Jutaan orang telah menjadi penumpang setia Primajasa</h2>
        </div>
      </div>
      ...
      <div class="row gy-4 mt-5 justify-content-center" data-aos="zoom-in" data-aos-delay="250">
        <div class="col-xl-2 col-md-4">
          <div class="icon-box">
            ...
            <h3><a href="">Ekonomis</a></h3>
          </div>
        </div>
        <div class="col-xl-2 col-md-4">
          <div class="icon-box">
            <i class="fas fa-dharmachakra"></i>
            <h3><a href="">Tepat Waktu</a></h3>
          </div>
        </div>
        <div class="col-xl-2 col-md-4">
          <div class="icon-box">
  ...
  <main id="main">
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          <div class="col-lg-6 order-1 order-lg-2" data-aos="fade-left" data-aos-delay="100">
            <img src="{{ asset('LandingPage/') }}/assets/img/abang.jpg" class="img-fluid" alt="">
          </div>
          <div class="col-lg-6 pt-4 pt-lg-0 order-2 order-lg-1 content" data-aos="fade-right" data-aos-delay="100">
            <h3>Kenapa Primajasa ?</h3>
            <p class="fst-italic">
            ...
            <ul>
              <li><i class="ri-check-double-line"></i> Kami telah berpengalaman sejak tahun 1991 melayani masyarakat dengan menyediakan jasa transportasi..</li>
              <li><i class="ri-check-double-line"></i> Kepastian keberangkatan adalah komitmen utama kami.              </li>
              <li><i class="ri-check-double-line"></i> Komitmen kami untuk memberikan rasa aman dan nyaman dalam perjalanan anda.              </li>
            </ul>
            <p> PT.PRIMAJASA PERDANARAYA UTAMA            </p>
          </div>
        </div>
    ...
    <section id="features" class="features">
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          <div class="image col-lg-6" style='background-image: url("{{ asset('LandingPage/') }}/assets/img/busah.jpg");' data-aos="fade-right"></div>
          <div class="col-lg-6" data-aos="fade-left" data-aos-delay="100">

            <div class="icon-box mt-5 mt-lg-0" data-aos="zoom-in" data-aos-delay="150">
                <h4>PT.PRIMAJASA PERDANARAYA UTAMA</h4>
                <p></p>
              </div>
            ...
            <div class="icon-box mt-5 mt-lg-0" data-aos="zoom-in" data-aos-delay="150">
              <i class="fas fa-wallet"></i>
              <h4>Ekonomis</h4>
              <p>Tarif yang murah, pasti, dan transparan. Selalu menjadi yang terdepan untuk memberikan pelayanan yang prima kepada semua penumpang.            </p>
            </div>
            ...
            <div class="portfolio-wrap">
              ...
              <div class="portfolio-info">
                ...
                <div class="portfolio-links">
                  <a href="{{ asset('LandingPage/') }}assets/img/portfolio/portfolio-1.jpg" data-gallery="portfolioGallery" class="portfolio-lightbox" title="App 1"><i class="bx bx-plus"></i></a>
                  <a href="{{ asset('LandingPage/') }}portfolio-details.html" title="More Details"><i class="bx bx-link"></i></a>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-web">
            <div class="portfolio-wrap">
              ...
              <div class="portfolio-info">
                ...
                <p>Web</p>
                <div class="portfolio-links">
                  <a href="{{ asset('LandingPage/') }}assets/img/portfolio/portfolio-2.jpg" data-gallery="portfolioGallery" class="portfolio-lightbox" title="Web 3"><i class="bx bx-plus"></i></a>
                  <a href="{{ asset('LandingPage/') }}portfolio-details.html" title="More Details"><i class="bx bx-link"></i></a>
                </div>
              </div>
            </div>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-app">
            <div class="portfolio-wrap">
              ...
              <div class="portfolio-info">
                ...
                <p>App</p>
                <div class="portfolio-links">
                  <a href="{{ asset('LandingPage/') }}assets/img/portfolio/portfolio-3.jpg" data-gallery="portfolioGallery" class="portfolio-lightbox" title="App 2"><i class="bx bx-plus"></i></a>
                  <a href="{{ asset('LandingPage/') }}portfolio-details.html" title="More Details"><i class="bx bx-link"></i></a>
                </div>
              </div>
            </div>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-card">
            <div class="portfolio-wrap">
              ...
              <div class="portfolio-info">
                ...
                <p>Card</p>
                <div class="portfolio-links">
                  <a href="{{ asset('LandingPage/') }}assets/img/portfolio/portfolio-4.jpg" data-gallery="portfolioGallery" class="portfolio-lightbox" title="Card 2"><i class="bx bx-plus"></i></a>
                  <a href="{{ asset('LandingPage/') }}portfolio-details.html" title="More Details"><i class="bx bx-link"></i></a>
                </div>
              </div>
            </div>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-web">
            <div class="portfolio-wrap">
              ...
              <div class="portfolio-info">
                ...
                <p>Web</p>
                <div class="portfolio-links">
                  <a href="{{ asset('LandingPage/') }}assets/img/portfolio/portfolio-5.jpg" data-gallery="portfolioGallery" class="portfolio-lightbox" title="Web 2"><i class="bx bx-plus"></i></a>
                  <a href="{{ asset('LandingPage/') }}portfolio-details.html" title="More Details"><i class="bx bx-link"></i></a>
                </div>
              </div>
            </div>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-app">
            <div class="portfolio-wrap">
              ...
              <div class="portfolio-info">
                ...
                <p>App</p>
                <div class="portfolio-links">
                  <a href="{{ asset('LandingPage/') }}assets/img/portfolio/portfolio-6.jpg" data-gallery="portfolioGallery" class="portfolio-lightbox" title="App 3"><i class="bx bx-plus"></i></a>
                  <a href="{{ asset('LandingPage/') }}portfolio-details.html" title="More Details"><i class="bx bx-link"></i></a>
                </div>
              </div>
            </div>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-card">
            <div class="portfolio-wrap">
              ...
              <div class="portfolio-info">
                ...
                <p>Card</p>
                <div class="portfolio-links">
                  <a href="{{ asset('LandingPage/') }}assets/img/portfolio/portfolio-7.jpg" data-gallery="portfolioGallery" class="portfolio-lightbox" title="Card 1"><i class="bx bx-plus"></i></a>
                  <a href="{{ asset('LandingPage/') }}portfolio-details.html" title="More Details"><i class="bx bx-link"></i></a>
                </div>
              </div>
            </div>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-card">
            <div class="portfolio-wrap">
              ...
              <div class="portfolio-info">
                ...
                <p>Card</p>
                <div class="portfolio-links">
                  <a href="{{ asset('LandingPage/') }}assets/img/portfolio/portfolio-8.jpg" data-gallery="portfolioGallery" class="portfolio-lightbox" title="Card 3"><i class="bx bx-plus"></i></a>
                  <a href="{{ asset('LandingPage/') }}portfolio-details.html" title="More Details"><i class="bx bx-link"></i></a>
                </div>
              </div>
            </div>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-web">
            <div class="portfolio-wrap">
              ...
              <div class="portfolio-info">
                ...
                <p>Web</p>
                <div class="portfolio-links">
                  <a href="{{ asset('LandingPage/') }}assets/img/portfolio/portfolio-9.jpg" data-gallery="portfolioGallery" class="portfolio-lightbox" title="Web 3"><i class="bx bx-plus"></i></a>
                  <a href="{{ asset('LandingPage/') }}portfolio-details.html" title="More Details"><i class="bx bx-link"></i></a>
                </div>
              </div>
            </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 d-flex align-items-stretch">
            <div class="member" data-aos="fade-up" data-aos-delay="400">
              <div class="member-img">
                <img src="{{ asset('LandingPage/') }}/assets/img/team/team-4.jpg" class="img-fluid" alt="">
                <div class="social">
                  <a href=""><i class="bi bi-twitter"></i></a>
                  <a href=""><i class="bi bi-facebook"></i></a>
                  <a href=""><i class="bi bi-instagram"></i></a>
  ...
  <footer id="footer">
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6">
            <div class="footer-info">
              <h3>primajasa<span>.</span></h3>
              <p>
                Kami telah berpengalaman sejak tahun 1991 melayani masyarakat dengan menyediakan jasa transportasi bis Antar Kota Antar Propinsi (AKAP) dan Antar Kota Dalam Propinsi (AKDP), Bis Pariwisata, Airport Shuttle, dan Taksi.<br><br>
              </p>
            </div>
          </div>
          <div class="col-lg-2 col-md-6 footer-links">
            ...
            <ul>
              ...
              <li><i class="bx bx-chevron-right"></i> <a href="#">Destinasi</a></li>
          ...
          <div class="col-lg-3 col-md-6 footer-links">
            <h4>Layanan Kami</h4>
            <ul>
              <li><i class="bx bx-chevron-right"></i> <a href="#">Bus Reguler</a></li>
              <li><i class="bx bx-chevron-right"></i> <a href="#">Angkutan Pemuda Moda</a></li>
              <li><i class="bx bx-chevron-right"></i> <a href="#">Redwhite Star Shuttle</a></li>
              <li><i class="bx bx-chevron-right"></i> <a href="#">Taxi</a></li>
              <li><i class="bx bx-chevron-right"></i> <a href="#">Bus Parawisata</a></li>
            </ul>
          </div>

          <div class="col-lg-4 col-md-6 footer-newsletter">
            <h4>Kontak Info</h4>
            <p>PT Primajasa Perdanaraya Utama
                Marante Rejeki Jaya Jl. Mayjen Sutoyo Blok Bersama No.24, RT.8/RW.8, Cililitan, Kramatjati, Kota Jakarta Timur, Daerah Khusus Ibukota Jakarta 13640.</p>
                <p>
                    <strong>Phone:</strong> 0218009545<br>
                    <strong>Email:</strong> info@primajasa.co.id<br>
                </p>
    ...
    <div class="container">
      <div class="copyright">
        © 2019 PT Primajasa Perdanaraya Utama Powered by Curalib
      </div>
      <div class="credits">
